...
if ($_SESSION['signed_in'] == false) {
    ...
    if ($_SERVER['REQUEST_METHOD'] != 'POST') {
                ...
                <tr>
                    <td>
                        <div class="inputImagenModificado">
                            <input class="inputImagenOculto" accept="image/jpeg" name="imagen1" type="file">
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        if (!$result) {
            ...
            //insert the topic into the topics table first, then well save the post into the posts table
